...
class ProjectAXN(Action):
    ...
    def __init__(self, name: Optional[str] = None, details: Optional[dict] = None, cfg: Optional[dict] = None):
...
class PyfficeProject(PyfficeDocumentManager):
    ...
    def __init__(self, cfg: Optional[dict] = None):
        super().__init__(cfg)
        self.config.override(condor.Instruct(pxcfg).select("PyfficeProject")).override(cfg)
        self.tasks = []
        self.resources = []
        self.milestones = []
        self.dependencies = []
