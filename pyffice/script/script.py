...
class PyfficeScript(PyfficeDocument):
    ...
    def add_footer(self, text, to_document=False) -> Self:
        """
    ...
    def add_header(self, title, author, to_document=False) -> Self:
        """
    ...
    def add_keyframes(self, name: str, frames: dict) -> Self:
        """
    ...
    def add_media_query(self, query: str, rules: list) -> Self:
        """
    ...
    def add_paragraph(self, text, alignment="left") -> Self:
        """
    ...
    def add_picture(self, image_path, width=None, height=None) -> Self:
        """
    ...
    def format_select(self, text, paragraph) -> Self:
...
def get_table_positions(docx_path) -> Any:
    """
